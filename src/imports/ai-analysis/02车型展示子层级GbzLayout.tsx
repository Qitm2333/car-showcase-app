...
import imgRectangle112 from "figma:asset/20d21687eb3c0d24063d8d5b3d337d6bfbe0c5db.png";
import imgRectangle113 from "figma:asset/4bfc41e80bf97daa177f40868a68906543ec614c.png";
import imgRectangle114 from "figma:asset/45a601cc1cb37689cbfa03738ff33abe187b62ca.png";
import imgRectangle115 from "figma:asset/671b94cd1d38a07acc86ec5966182f98453d644c.png";
import imgRectangle116 from "figma:asset/1a5225610106a6cb77ba07520f45c80237db371c.png";
...
function Component1() {
  return (
    <div className="absolute contents font-bold leading-[0] left-[325px] not-italic text-nowrap top-[160px]" data-name="导航栏文字">
      <div className="absolute flex flex-col font-['Inter:Bold',_'Noto_Sans_SC:Bold',_sans-serif] justify-center left-[325px] text-[30px] text-[rgba(0,0,0,0.4)] top-[177.5px] translate-y-[-50%]">
        <p className="leading-[35px] text-nowrap whitespace-pre">腾势N7</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Bold',_sans-serif] justify-center left-[432px] text-[40px] text-[rgba(0,0,0,0.4)] top-[177.5px] translate-y-[-50%]">
        <p className="leading-[35px] text-nowrap whitespace-pre">{` /`}</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Bold',_'Noto_Sans_JP:Bold',_'Noto_Sans_SC:Bold',_sans-serif] justify-center left-[475px] text-[30px] text-[rgba(0,0,0,0.95)] top-[177.5px] translate-y-[-50%]">
        <p className="leading-[35px] text-nowrap whitespace-pre">比亚迪海豹</p>
      </div>
    </div>
  );
}
...
function Back() {
  return (
    <div className="absolute contents left-[322px] top-[114px]" data-name="Back组件">
...
function Component5() {
  return (
    <div className="absolute h-[1117px] left-0 top-0 w-[273px]" data-name="Component 5">
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_JP:Regular',_'Noto_Sans_SC:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal inset-[70.01%_24.91%_28.47%_32.97%] justify-center leading-[0] not-italic text-[14px] text-[rgba(0,0,0,0.8)] text-nowrap">
  ...
  return (
    <div className="absolute bottom-[69.58%] contents left-0 right-0 top-0">
      ...
      <div className="absolute bottom-[69.58%] left-[60.88%] right-[20.32%] rounded-[10px] top-0">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle115} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute bottom-[34.79%] contents left-0 right-0 top-[34.79%]">
      <div className="absolute bottom-[34.79%] left-0 right-[81.19%] rounded-[10px] top-[34.79%]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle116} />
      </div>
...
function VehiclePreviewGrid() {
  return (
    <div className="absolute aspect-[1349.96/457] left-[322px] overflow-clip right-[56.04px] top-[755px]" data-name="车辆预览图">
      <VehiclePreviewGroup2 />
      <VehiclePreviewGroup1 />
      <VehiclePreviewGroup />
    </div>
  );
}
...
function RelatedCars() {
  return (
    <div className="absolute contents left-[28px] top-[285px]" data-name="相关车型">
      <div className="absolute flex flex-col font-['Inter:Bold',_'Noto_Sans_JP:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic right-[362px] text-[15px] text-[rgba(0,0,0,0.8)] top-[373px] translate-x-[100%] translate-y-[-50%] w-[89px]">
...
function TagFrame() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-[28px] items-center pb-[28px] pt-0 px-0 right-[270px] top-[314px] w-[92px]">
      <div className="bg-[#f2f2f2] h-[28px] mb-[-28px] rounded-[81px] shrink-0 w-full" />
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal h-[28px] justify-center leading-[0] mb-[-28px] not-italic relative shrink-0 text-[16px] text-black text-center w-[61px]">
        <p className="leading-[normal]">ADS 2.0</p>
      </div>
    </div>
  );
}
...
function TagGroup9() {
  return (
    <div className="absolute contents right-[201px] top-[314px]">
      <div className="absolute bg-[#f2f2f2] h-[28px] right-[201px] rounded-[81px] top-[315px] w-[60px]" />
      <div className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_JP:Regular',_'Noto_Sans_SC:Regular',_sans-serif] font-normal h-[31px] justify-center leading-[0] not-italic right-[247px] text-[16px] text-black top-[329.5px] translate-x-[100%] translate-y-[-50%] w-[41px]">
        <p className="leading-[normal]">木纹</p>
      </div>
    </div>
  );
}
...
function TagGroup8() {
  return (
    <div className="absolute contents right-[88px] top-[314px]">
      <div className="absolute bg-[#f2f2f2] h-[28px] right-[88px] rounded-[81px] top-[315px] w-[104px]" />
      <div className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_JP:Regular',_sans-serif] font-normal h-[31px] justify-center leading-[0] not-italic right-[181px] text-[16px] text-black top-[329.5px] translate-x-[100%] translate-y-[-50%] w-[93px]">
        <p className="leading-[normal]">Nappa真皮</p>
      </div>
    </div>
  );
}
...
function AiAnalysisCard() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[10px] h-[493px] items-center justify-end right-[54px] rounded-[18px] top-[222px] w-[390px]" data-name="AI分析">
      ...
      <div className="absolute flex flex-col font-['Inter:Bold',_'Noto_Sans_JP:Bold',_'Noto_Sans_SC:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic right-[29px] text-[#6062ef] text-[15px] text-right top-[49px] translate-y-[-50%] w-[74px]">
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_SC:Regular',_'Noto_Sans_JP:Regular',_sans-serif] font-normal h-[170px] justify-center leading-[0] not-italic right-[362px] text-[16px] text-black top-[184px] translate-x-[100%] translate-y-[-50%] w-[333px]">
        <p className="leading-[2]">问界M7以"豪华+智能"为核心,内饰用Nappa真皮、木纹饰板营造质感,舒云座椅配多档按摩。华为ADS 2.0与多屏交互加持,静音性与环保性拉满,细节见品质。</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal h-[28px] justify-center leading-[0] not-italic right-[29px] text-[18px] text-black text-right top-[81px] translate-y-[-50%] w-[149px]">
        <p className="leading-[normal]">$27.98-$37.98</p>
      </div>
...
function StarVector() {
  return (
    <div className="absolute right-[496px] size-[34px] top-[241px]" data-name="Vector">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Vector">
          <path clipRule="evenodd" d={svgPathsCarDisplay.p3726c700} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector-31" />
        </g>
      </svg>
    </div>
  );
...
function StarVector1() {
  return (
    <div className="absolute inset-[20.833%]" data-name="Vector">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="Vector">
          <path clipRule="evenodd" d={svgPathsCarDisplay.p367a0f00} fill="var(--fill-0, #6062EF)" fillRule="evenodd" id="Vector-31" />
        </g>
      </svg>
    </div>
  );
...
function XnixLineStar() {
  return (
    <div className="absolute right-[489px] size-[48px] top-[234px]" data-name="Xnix/Line/Star">
      <StarVector1 />
    </div>
  );
}
...
function FavoriteButton() {
  return (
    <div className="absolute contents right-[489px] top-[234px]" data-name="收藏">
      <StarVector />
      <XnixLineStar />
    </div>
  );
  ...
  return (
    <div className="absolute contents left-[322px] top-[222px]" data-name="车辆主图片">
      ...
      <div className="absolute h-[493px] left-[322px] pointer-events-none right-[475px] rounded-[18px] top-[222px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[18px] size-full" src={imgRectangle111} />
...
export default function Component02GbzLayout() {
  return (
    <div className="bg-white relative size-full" data-name="02车型展示-子层级-GBZ-layout">
      <Component />
      <Component1 />
      <Back />
      <Component3 />
