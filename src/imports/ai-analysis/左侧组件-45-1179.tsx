import svgPaths from "./svg-lt6sj6nxih";
...
/**
 * @figmaAssetKey 0d30926044cbce5c09c08a8f809c6a837c3d2ce7
 */
function Ai({ className }: { className?: string }) {
  return (
    <div className={className} data-name="AI分析组件亮条">
        ...
        <div className="absolute bottom-[-3.76%] left-[-0.43%] right-[-0.43%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 234 56">
            <g filter="url(#filter0_d_45_1183)" id="Group 1437252927">
              <path d={svgPaths.pf796d80} fill="url(#paint0_linear_45_1183)" id="Rectangle 33" stroke="var(--stroke-0, #C8A6FF)" strokeWidth="0.2" />
            </g>
            <defs>
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="左侧组件">
      <Component1 />
      <Ai className="absolute h-[55px] left-[19px] top-[601px] w-[243px]" />
    </div>
  );
}