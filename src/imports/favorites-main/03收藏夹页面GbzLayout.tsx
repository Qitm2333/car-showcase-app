...
interface FavoriteCard1Props {
  onFavoriteClick?: () => void;
}

function FavoriteCard1({ onFavoriteClick }: FavoriteCard1Props) {
  return (
    <div 
      className="absolute bottom-[53.18%] content-stretch flex flex-col gap-[10px] items-center justify-end left-0 right-[76.15%] top-0 cursor-pointer" 
      data-name="越野车外饰对标"
      onClick={onFavoriteClick}
    >
      <FavoriteCardTitle title="越野车外饰对标" count="10" />
...
function FavoriteCard2() {
  return (
    <div className="absolute bottom-[53.18%] content-stretch flex flex-col gap-[10px] items-center justify-end left-[25.41%] right-[50.74%] top-0" data-name="宝马三系对标">
      <FavoriteCardTitle title="宝马三系对标" count="35" />
      <div className="absolute bottom-[20.09%] left-0 pointer-events-none right-0 rounded-[20px] top-0">
        <div aria-hidden="true" className="absolute inset-0 rounded-[20px]">
          <div className="absolute bg-[#f8f8f8] inset-0 rounded-[20px]" />
...
function FavoriteCard3() {
  return (
    <div className="absolute bottom-[53.18%] content-stretch flex flex-col gap-[10px] items-center justify-end left-[50.74%] right-[25.41%] top-0">
      <FavoriteCardTitle title="门板扣手对标" count="10" />
      <div className="absolute bottom-[20.09%] left-0 pointer-events-none right-0 rounded-[20px] top-0">
        <div aria-hidden="true" className="absolute inset-0 rounded-[20px]">
...
function FavoriteCard4() {
  return (
    <div className="absolute bottom-[53.18%] content-stretch flex flex-col gap-[10px] items-center justify-end left-[76.15%] right-0 top-0" data-name="SUV尾灯收集">
      <FavoriteCardTitle title="SUV尾灯收集" count="5" />
      <div className="absolute bottom-[20.09%] left-0 pointer-events-none right-0 rounded-[20px] top-0">
...
function FavoriteCard5() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[10px] items-center justify-end left-0 right-[76.15%] top-[53.18%]" data-name="后备箱空间研究">
      <FavoriteCardTitle title="后备箱空间研究" count="32" />
      <div className="absolute bottom-[20.09%] left-0 pointer-events-none right-0 rounded-[20px] top-0">
...
function FavoriteCard6() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[10px] items-center justify-end left-[25.41%] right-[50.74%] top-[53.18%]" data-name="越野车IP方案收集">
      <FavoriteCardTitle title="越野车IP方案收集" count="8" />
      <div className="absolute bottom-[20.09%] left-0 pointer-events-none right-0 rounded-[20px] top-0">
...
function FavoritesGroup({ onFavoriteClick }: FavoritesGroupProps) {
  return (
    <div className="absolute contents inset-0">
      <FavoriteCard1 onFavoriteClick={onFavoriteClick} />
      <FavoriteCard2 />
      <FavoriteCard3 />
      <FavoriteCard4 />
      <FavoriteCard5 />
...
function FavoritesGrid({ onFavoriteClick }: FavoritesGridProps) {
  return (
    <div className="absolute aspect-[1350/487] left-[322px] overflow-clip right-[56px] top-[222px]">
      <FavoritesGroup onFavoriteClick={onFavoriteClick} />
    </div>
  );
}
...
export default function Component03FavoritesGbzLayout({ onFavoriteClick }: Component03FavoritesGbzLayoutProps) {
  return (
    <div className="bg-white relative size-full" data-name="03收藏夹-GBZ">
      ...
      <FavoritesGrid onFavoriteClick={onFavoriteClick} />
      <FavoritesTitle />
    </div>
  );
}
