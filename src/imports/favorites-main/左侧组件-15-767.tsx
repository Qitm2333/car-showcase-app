...
function Component3() {
  return (
    <div className="absolute h-[1117px] left-0 top-0 w-[273px]" data-name="Component 5">
      ...
      <div className="absolute size-[22px] left-[-50px] top-[408px]" data-name="收藏 未收藏 1">
      ...
      <div className="absolute aspect-[200/200] left-[19.05%] right-[72.53%] top-[618px]" data-name="AI-04 1">
        <img alt="" className="absolute inset-0 max-w-none object-center object-cover pointer-events-none size-full" src={imgAi041} />
      </div>
      ...
      <Group6 />
      {/* 收藏夹高亮条 - 完整组件，放在最高层 */}
      <div className="absolute h-[53.143px] left-[19px] top-[408px] w-[232px] z-50">
        <HighlightBar />
      </div>
