import svgPaths from "./svg-2oczj8fsfm";
...
/**
 * @figmaAssetKey 024565d42db7376e9755cc59b467b21c7d91a7a8
 */
...
export default function Component1() {
  return (
    <div className="relative size-full" data-name="左侧组件">
      <Component2 />
      <Component className="absolute h-[53.143px] left-[19px] top-[392px] w-[232px]" />
    </div>
  );
}