import svgPaths from "./svg-c0u9sgduw3";
import imgRectangle41 from "figma:asset/0f348fc38bfd7a955914a721fc8a6cea89ab5ea8.png";
  ...
  return (
    <div className="absolute right-[496px] size-[34px] top-[241px]" data-name="Vector">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Vector">
          <path clipRule="evenodd" d={svgPaths.p3726c700} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector-31" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute inset-[20.833%]" data-name="Vector">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="Vector">
          <path clipRule="evenodd" d={svgPaths.p367a0f00} fill="var(--fill-0, #6062EF)" fillRule="evenodd" id="Vector-31" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute contents left-[322px] top-[222px]" data-name="车辆主图片">
      ...
      <div className="absolute h-[493px] left-[322px] pointer-events-none right-[475px] rounded-[18px] top-[222px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[18px] size-full" src={imgRectangle41} />
