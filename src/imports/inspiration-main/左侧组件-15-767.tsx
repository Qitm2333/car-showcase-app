import svgPaths from "./svg-fx7dsnd9i9";
import HighlightBar from "./选中亮条-32-3229";
...
function Component3() {
  const handleUnauthorized = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    alert("暂无权限");
  };
    ...
    <div className="absolute h-[1117px] left-0 top-0 w-[273px]" data-name="Component 5">
      <div className="absolute bottom-[-0.18%] left-0 right-0 top-0" data-name="BG01">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 273 1119">
          <g id="BG01">
            <path d="M0 0H273V1119H0V0Z" fill="url(#paint0_linear_15_771)" fillOpacity="0.7" />
            <path d="M0 0H273V1119H0V0Z" fill="var(--fill-1, #F4F5FF)" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_15_771" x1="130.026" x2="-10" y1="-1.11657" y2="1089">
      ...
      {/* 我的项目 - 禁用功能，点击显示暂无权限 */}
      <div onClick={handleUnauthorized} className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_JP:Regular',_'Noto_Sans_SC:Regular',_sans-serif] font-normal inset-[42.7%_37.73%_55.15%_32.97%] justify-center leading-[0] not-italic text-[20px] text-[rgba(0,0,0,0.8)] text-nowrap cursor-pointer hover:opacity-70 transition-opacity">
        <p className="leading-[normal] whitespace-pre">我的项目</p>
      </div>
      {/* 线上评审 - 禁用功能，点击显示暂无权限 */}
      <div onClick={handleUnauthorized} className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_SC:Regular',_'Noto_Sans_JP:Regular',_sans-serif] font-normal inset-[48.97%_37.73%_48.88%_32.97%] justify-center leading-[0] not-italic text-[20px] text-[rgba(0,0,0,0.8)] text-nowrap cursor-pointer hover:opacity-70 transition-opacity">
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_JP:Regular',_'Noto_Sans_KR:Regular',_'Noto_Sans_SC:Regular',_sans-serif] font-normal inset-[75.29%_28.94%_23.19%_32.97%] justify-center leading-[0] not-italic opacity-80 text-[14px] text-[rgba(0,0,0,0.8)] text-nowrap">
      ...
      <Group6 />
      {/* 灵感搜集高亮条 - 完整组件，放在最高层 */}
      <div className="absolute h-[53.143px] left-[19px] top-[322px] w-[232px] z-50">
        <HighlightBar />
      </div>
